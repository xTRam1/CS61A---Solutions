...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        if self.place.ant is None:
            return False
        elif self.place.ant is not None and self.place.ant.blocks_path == True:
            return True
        return False
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        curr_range = 0
        while len(curr_place.bees) == 0 and curr_place.entrance != beehive:
...
# BEGIN Problem 8
class WallAnt(Ant):
    """A WallAnt does nothing. It acts as a shiled for its ant colony."""
    name = "Wall"
    food_cost = 4
    implemented = True
# END Problem 8
