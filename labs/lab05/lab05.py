...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    dist_1, dist_2 = distance(make_city('dest1', lat, lon), city1), distance(make_city('dest2', lat, lon), city2)
    if dist_1 < dist_2:
...
def add_chars(w1, w2):
    ...
    """
    def helper(w1, w2, so_far):
        if w1 == "":
            return so_far
        elif w1[0] in w2:
            return helper(w1[1:], w2, so_far)
        else:
            return helper(w1[1:], w2, so_far + w1[0])
    return helper(w1, w2, "")"""
